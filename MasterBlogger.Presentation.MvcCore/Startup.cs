...
using MasterBlogger.Infrastructure.Config;
...
namespace MasterBlogger.Presentation.MvcCore
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //services.AddDbContext<MasterBloggerContext>(options => options.UseSqlServer(Configuration.GetConnectionString("MasterBloggerDb")));
